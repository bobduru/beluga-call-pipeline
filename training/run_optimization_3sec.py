...
labels_df = pd.read_csv("data/Verified_Dataset/labels/labels_merged_3sec.csv")
...
data_dir = "data"
processed_spects_dir = data_dir + "/Verified_Dataset/spectrograms_3sec/"

results_dir = "training/results/optimization_3sec"
